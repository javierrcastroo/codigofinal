...
def main() -> None:
    # 0) Clean destination (external table location)
    ...
    try:
        ...
        cur.execute(
            ...
            """.format(db=DB_NAME, tgt=TARGET_TBL, dest=DEST_PARQUET_DIR)
        )
